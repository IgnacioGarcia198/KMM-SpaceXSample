package com.garcia.ignacio.sqldelighttest.android.compose
...
import com.garcia.ignacio.sqldelighttest.android.compose.theme.AppTheme
    ...
    Scaffold(
        ...
        Box(
            ...
            if (state.isLoading) {
                ...
                LazyColumn {
                    items(state.launches.size) { index: Int ->
                        val launch = state.launches[index]
